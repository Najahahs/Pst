...
class FacebookCommenter:
    ...
    def comment_on_post(self, cookies, post_id, comment, delay):
        with requests.Session() as r:
            ...
            response = r.get('https://business.facebook.com/{}'.format(post_id), cookies={"cookie": cookies})
            ...
            r.headers.update({
                ...
                'referer': 'https://business.facebook.com/{}'.format(post_id),
                'origin': 'https://business.facebook.com',
            })

            response2 = r.post('https://business.facebook.com{}'.format(self.next_action), data=data, cookies={"cookie": cookies})
